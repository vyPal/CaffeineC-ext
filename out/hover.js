            ...
            switch (word) {
                ...
                case 'float':
                    return new vscode.Hover('**`float`**\n\n' +
                        ...
                        '```');
                case 'double':
                    return new vscode.Hover('**`double`**\n\n' +
